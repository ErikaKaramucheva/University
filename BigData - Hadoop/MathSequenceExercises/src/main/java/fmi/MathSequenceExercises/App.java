package fmi.MathSequenceExercises;
...
public class App {
    public static void main(String[] args) {
        ...
        Path inputPath=new Path("hdfs://127.0.0.1:9000/input/math.txt");
        Path outputPath=new Path("hdfs://127.0.0.1:9000/result");
        JobConf job=new JobConf(config);
        job.setMapperClass(MathMapper.class);
        job.setReducerClass(MathReducer.class);
